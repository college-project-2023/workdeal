    ...
    <>
    {
        ...
        <Dialog open={profile} onClose={closeprofile} >
            ...
            <img
                      ...
                      />
            <DialogTitle>Nameyuuuuuuuuuuuuuuuuuuuuuuuuuuuuuu</DialogTitle>
            <DialogTitle>profession</DialogTitle>
        </Dialog>
    }
                ...
                >
                  <div class="d-flex bd-highlight">
                    ...
                    <div class={styles.video_cam} >
                      ...
                      >
                        <i class="fas fa-phone" onClick={handlephone}></i>
                      </span>
                    </div>
                  </div>
                  {/* <span
                ...
                >
                  <div class="d-flex justify-content-start mb-4">
                    ...
                    <div class={styles.msg_cotainer}>
                      ...
                      <span class={styles.msg_time}>8:40 AM, Today</span>
                    </div>
                  </div>
                  <div class="d-flex justify-content-end mb-4">
                    <div className={styles.msg_cotainer_send}>
                      Hi Khalid i am good tnx how about you?
                      <span class={styles.msg_time_send}>8:55 AM, Today</span>
                    </div>
                    <div
                      class="img_cont_msg"
                      style={{ height: "40px", width: "40px" }}
                  ...
                  <div class="d-flex justify-content-start mb-4">
                    ...
                    <div class={styles.msg_cotainer}>
                      ...
                      <span class={styles.msg_time}>9:00 AM, Today</span>
                    </div>
                  </div>
                  <div class="d-flex justify-content-end mb-4">
                    <div className={styles.msg_cotainer_send}>
                      You are welcome
                      <span class={styles.msg_time_send}>9:05 AM, Today</span>
                    </div>
                    <div
                      class="img_cont_msg"
                      style={{ height: "40px", width: "40px" }}
                  ...
                  <div class="d-flex justify-content-start mb-4">
                    ...
                    <div class={styles.msg_cotainer}>
                      Bye, see you
                      <span class={styles.msg_time}>9:12 AM, Today</span>
                    </div>
                  </div>
                </div>
                <div
